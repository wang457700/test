            ...
            <input type="hidden" id="c-avatar" name="row[avatar]" value="<?php echo $admin['avatar']; ?>" />
                 <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <input type="text" class="form-control" id="slide_name" name="row[data1]" value="" data-rule="required;data1" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <input type="text" class="form-control" id="slide_url" name="row[data2]" value="" data-rule="required;data2" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <input type="text" class="form-control" id="slide_url" name="row[data3]" value="" data-rule="required;data3" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <input type="text" class="form-control" id="slide_url" name="row[data4]" value="" data-rule="required;data4" />
                    </div>
                </div> 
                ...
                <div class="form-group on danxuan">
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-5">
                            <input type="text" class="form-control" id="data5" name="row[data5]" value="" data-rule=";data5" />
                        </div>
                    </div>
                </div> 
                <div class="form-group danxuan"> 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-5">
                            <input type="text" class="form-control" id="data6" name="row[data6]" value="" data-rule=";data6" />
                        </div>
                    </div>
                </div> 
                <div class="form-group danxuan" > 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <input type="text" class="form-control" id="data7" name="row[data7]" value="" data-rule=";data7" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <div class="input-group">
                            <input id="c-image" class="form-control" size="50" name="row[data8]" type="hidden" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-1">
                        <div class="input-group">
                            <input id="c-image1" class="form-control" size="50" name="row[data9]" type="hidden" value="">
                            <div class="input-group-addon no-border no-padding">
                    ...
                    <div class="col-xs-12 col-sm-1">
                        <div class="input-group">
                            <input id="c-image2" class="form-control" size="50" name="row[data9]" type="hidden" value="">
                            <div class="input-group-addon no-border no-padding">
                    ...
                    <div class="col-xs-12 col-sm-1">
                        <div class="input-group">
                            <input id="c-image3" class="form-control" size="50" name="row[data9]" type="hidden" value="">
                            <div class="input-group-addon no-border no-padding">
                ...
                <div class="form-group"> 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="data10" name="row[data10]" value="" data-rule="required;" />
                        </div>
                    </div>
                </div>
                <div class="form-group"> 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-2">
                            <input type="text" class="form-control" id="data11" name="row[data11]" value="" data-rule="required;data11" />
                        </div>
                        <div class="col-xs-12 col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <?php echo build_radios('row[slide_status]', ['0'=>'TOP 10', '1'=>'熱銷', '2'=>'精選'], 0); ?>
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="data1" name="row[data12]" value="" data-rule="required;data12" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="data2" name="row[data13]" value="" data-rule="required;data13" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input type="text" class="form-control" id="slide_url" name="row[data14]" value="" data-rule="required;data14" />
                        </div>
                    </div>
                </div>
