<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\index\index.html";i:1534844858;s:68:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\common\header.html";i:1534845365;s:65:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\common\nav.html";i:1534399127;s:68:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\common\footer.html";i:1534399159;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<!--头部 end-->
  ...
  <div class="swiper-container" style="">
      <div class="swiper-wrapper">
            <div class="swiper-slide"> 
              <a href="#"  target="_bank">
                <img src="/fastadmin/template/pc/common/img/banner1.jpg">
              </a>
            </div>
            <div class="swiper-slide"> 
              <a href="#"  target="_bank">
    ...
    <div class="position_ads" style="">
      <div class="ads_left" style="width: 12%;z-index: 9999;">
          <a class="close" href="javascript:$('.ads_left').hide()">×</a>
          <img src="/fastadmin/template/pc/common/img/ads_2.png">
      </div>
      
      <div class="ads_right" style="width: 16%;z-index: 9999;right: 0;">
    	 	<a class="close" href="javascript:$('.ads_right').hide()">×</a>
      	<div class="index_news" style="">
      			<div class="title" style=""></div>
      			<ul style="">
      				<li>
      					<img src="/fastadmin/template/pc/common/img/index_news_img.png">
      					<p>安神龍眼百合茶唔怕眼光光… </p>
      					<p >材料：龍眼肉10克百合…</p>
      					<p>2018-07-03，週二</p>
      				</li>
          ...
          <img src="/fastadmin/template/pc/common/img/ads_1.png">
    		</div>
    </div>
    ...
    <div class="container">
       ...
       <div class="row" style="padding: 20px 0;">
        <div class="col-md-5 col-xs-5" style="padding-left: 0;">
             ...
             <div class="row  f1">
              <div class="col-md-5 col-xs-5 list">
					<div style="padding: 1em;"><img src="/fastadmin/template/pc/common/img/f2_1.jpg"></div>
                    <p>安而康成人纸尿片</p>
              </div>
               <div class="col-md-5 col-xs-5 list margin_0">
					<div style="padding: 1em;"><img src="/fastadmin/template/pc/common/img/f2_1.jpg"></div>
                    <p>安而康成人纸尿片</p>
               </div>
            </div>
        </div>
        <div class="col-md-7 f2 col-xs-7" style="padding: 0;">
            ...
            <div class="swiper-container2" style="overflow: hidden;position: relative;">
              <div class="swiper-wrapper row">
                  <div class="swiper-slide col-md-3 list">
                      <p>ATex sports 肌肉運動貼</p>
                      <img src="/fastadmin/template/pc/common/img/f2_1.jpg">
                      <span class="font24"><i class="font12">$</i>1234</span>
                      <a class="adds">+</a>
                  </div>
                  <div class="swiper-slide col-md-3 list">
                      <p>ATex sports 肌肉運動貼</p>
        ...
        <div class="row advert" style="padding: 20px 0;">
          <div class="col-md-4 col-xs-4" style="padding: 0;">
              <img src="/fastadmin/template/pc/common/img/gg1.jpg">
          </div> 
          <div class="col-md-8 col-xs-8 p_right_0">

              <img src="/fastadmin/template/pc/common/img/gg2.jpg" style="margin-bottom: 1.5em;">
              <br>
              <img src="/fastadmin/template/pc/common/img/gg3.jpg">
  ...
  <!--- f3 str-->
        <div class="row f3" style="padding: 20px 0;">
          <p class="index_title" style="background-position-y: -50px;"> 復康產品</p>
          <div class="border_top1"></div>
          <div class="col-md-2 col-xs-2 n1"> 
              <img src="/fastadmin/template/pc/common/data/index_2.png">
              <div class="d1">
                <p class="font16 bold">Polar 心率錶</p>
                <p class="font12 miaosu">Polar 心率錶 銀黑色 - FT4-SBLK，針對想透過基於心率的基本功能保持簡單健身訓練的人們</p>
                <div>
                    <span class="font24"><i class="font12">$</i>1234</span>
                    <a class="adds">+</a>
                </div>
          ...
          <div class="col-md-10 col-xs-10 " style="background: #fff;">
              <div class="row">
                <div class="col-md-12">
                        <div class="row">
                          <div class="col-md-6 col-xs-6 n2">
								<div style="text-;text-align:  center;"><img src="/fastadmin/template/pc/common/img/f2_1.jpg" class="first"></div>
                                <div class="d2">
                                  <p>GH 人造皮 1-5 磅可調重量運動沙包</p>
                                  <p class="color_ro">优惠全民享</p>
                                  <div>
                                       <span class="font24"><i class="font12">$</i>1234</span>
                                      <a class="adds" style="padding: 0.4em 0.8em;">+</a>
                                  </div>
                                </div>
                            </div> 

                            <div class="col-md-3 col-xs-3 n2">
                                <img src="/fastadmin/template/pc/common/img/f2_1.jpg">
                                <div class="d2">
                                  <p>GH 人造皮 2 磅運動沙包</p>
                                  <p class="color_ro">优惠全民享</p>
...
<!--- f4 str-->
        <div class="row f3" style="padding: 20px 0;">
          ...
          <div class="border_top1"></div>
          <div class="col-md-2 col-xs-2 n1"> 
              <img src="/fastadmin/template/pc/common/data/index_1.png">
              <div class="d1">
				<p class="font16 bold">Polar 心率錶</p>
                <p class="font12 miaosu">Polar 心率錶 銀黑色 - FT4-SBLK，針對想透過基於心率的基本功能保持簡單健身訓練的人們</p>
                <div>
...
<!--- f6 str-->
        <div class="row f6" style="padding: 20px 0;"> 
          ...
          <div class="border_top1"></div>
			...
			<div class="row" style="margin: 0;padding: 2em 20px;background:  #fff;border-radius: 0 0 5px 5px;">
			  <div class="col-md-6 col-xs-6 list"> 
					<img src="/fastadmin/template/pc/common/img/f2_1.jpg" class="img_left" />
					<div class="d1">
					  <h3>Bremed Tens電療機2Channels</h3>
					  <p>最近在營康薈網站新購買的產品，買回來后才發現不太適合我自己用，身邊也沒有親人朋友需要，所以轉讓出來，產品沒有任何破損，有需要的朋友請與我聯繫，謝謝。</p>
					</div>
			  </div>
			  <div class="col-md-6 col-xs-6 list"> 
					<img src="/fastadmin/template/pc/common/img/f2_1.jpg" class="img_left" />
