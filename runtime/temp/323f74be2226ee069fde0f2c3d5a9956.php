<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\extend\page\edit.html";i:1534498804;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\layout\default.html";i:1529292885;s:77:"D:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1529292885;s:79:"D:\phpStudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1529292885;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="post_title" name="row[post_title]" value="<?php echo $row['post_title']; ?>" data-rule="required;post_title" />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">狀態</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[post_status]', [ '1'=>'顯示','0'=>'隐藏'], $row['post_status']); ?>
        </div>
    </div>
   <div class="form-group">
        <label for="username" class="control-label col-xs-12 col-sm-2">詳情</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-post_content" data-rule="" class="form-control editor" rows="15" name="row[post_content]" cols="50"><?php echo $row['post_content']; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group hidden layer-footer">
        ...
        <div class="col-xs-12 col-sm-8">
            <button type="submit" class="btn btn-success btn-embossed disabled">確定修改</button>
        </div>
    </div>
