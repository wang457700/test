<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\news\index.html";i:1534845684;s:73:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\layout\public_head.html";i:1534845439;s:68:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\common\header.html";i:1534845383;s:65:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\common\nav.html";i:1534399127;s:68:"D:\phpStudy\PHPTutorial\WWW\fastadmin\template\pc\common\footer.html";i:1534845661;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Required meta tags -->
...
<div class="nav_menu">
    ...
    <div class="row top_banner"><img src="/fastadmin/template/pc/common/img/info_top_banner.jpg" class="col-md-12" /></div>
     <div class="container info_list bgcolor_white" >
             
        <div class="row">
            <div class="col-sm-2 left-list" style="padding:0">
                    <div class="left-title">
                        <h3>社區</h3>
                        <span>Community</span>
                    </div>
                    <div class="left-ist">
                        <a href="" class="on">活動資訊</a> 
                        <a href="">專  訪</a> 
                    </div>
        
            </div>

            <div class="col-sm-10 right-list">
         
                <ol class="breadcrumb" style="padding:  20px;background-color: #fff;border-bottom: 1px solid #eee;">
                    <li><a href="#">首頁</a></li>
                    <li class="active"><a href="#">社區服務資訊</a></li>
                </ol>
                <ul>
                    ...
                    ?>
                        <li class="row">
                            <div class="col-sm-3 d1">
                                <img src="<?php echo fa_get_image_url($vo['smeta']); ?>" />
                            </div>
                            <div class="col-sm-7 d2">
                                <h4><a href="<?php echo url('home/news/article',array('id'=>$vo['id'])); ?>"><?php echo $vo['post_title']; ?></a></h4>
                                <p>
                                    <?php echo $vo['post_excerpt']; ?>
                                </p>
                            </div>
                            <div class="col-sm-2 d3">
                                <p><?php echo date('m-d',strtotime($vo['post_date'])); ?><br><i class="fa fa-long-arrow-right" aria-hidden="true"></i></p>
                            </div>
                        </li>
                   ...
                   <!--
                    ...
                    <li class="row">
                        <div class="col-sm-3 d1">
                            <img src="/fastadmin/template/pc/common/img/info_list_img1.jpg" />
                        </div>
                        <div class="col-sm-7 d2">
                            <h4>母親節KTO展銷</h4>
                            <p>
                                活動日期：7月11日-7月21日<br/>
                                活動時間：11:00 —— 20:00<br/>
                                活動地址：新界將軍澳長寧路2號TKO Gateway 東翼地下堂
                            </p>
                        </div>
                        <div class="col-sm-2 d3">
                            <p>10-19<br><i class="fa fa-long-arrow-right" aria-hidden="true"></i></p>
                        </div>
                    </li>-->


                </ul>
                <div class="pagination ya2">
                    <ul > 
                        <li><a href="#">上一頁</a> </li>
