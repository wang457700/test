...
return [
    ...
    'upload write error'                                        => '文件上傳保存错误！',
    'has the same filename: {:filename}'                        => '存在同名文件：{:filename}',
    'upload illegal files'                                      => '非法上傳文件',
    'illegal image files'                                       => '非法图片文件',
    'extensions to upload is not allowed'                       => '上傳文件后缀不允许',
    'mimetype to upload is not allowed'                         => '上傳文件MIME类型不允许！',
    ...
    ':attribute out of accord with :2'                          => ':attribute和確认字段:2不一致',
