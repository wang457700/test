...
return [
    ...
    'Pay tips'                       => '扫码支付后如果仍然無法立即下载，请不要重复支付，请加<a href="https://jq.qq.com/?_wv=1027&k=487PNBb" target="_blank">QQ群：636393962</a>向管理员反馈',
    'Pay click tips'                 => '请点击这里在新窗口中进行支付！',
    'Pay new window tips'            => '请在新弹出的窗口中进行支付，支付完成后再重新点击安装按钮进行安装！',
    'Uninstall tips'                 => '確认卸载[%s]？<p class="text-danger">卸载将会删除所有插件文件且不可找回!!! 插件如果有创建数据库表请手动删除!!!</p>如有重要数据请备份后再操作！',
    'Upgrade tips'                   => '確认升级[%s]？<p class="text-danger">如果之前购买插件时未登录，此次升级可能出现购买后才可以下载的提示!!!<br>升级后可能出现部分冗余数据记录,请根据需要移除即可!!!</p>如有重要数据请备份后再操作！',
    'Offline installed tips'         => '插件安装成功！清除浏览器缓存和框架缓存后生效！',
    'Online installed tips'          => '插件安装成功！清除浏览器缓存和框架缓存后生效！',
    'Not login tips'                 => '你当前未登录FastAdmin，登录后将同步已购买的记录，下载时無需二次付费！',
    ...
    'Disable'                        => '禁用',
    'Enable'                         => '启用',
    'Your username or email'         => '你的用戶名或邮箱',
    'Your password'                  => '你的密码',
    ...
    'Addon already exists'           => '上傳的插件已经存在',
    'Unable to open the zip file'    => '無法打开ZIP文件',
    'Unable to extract the file'     => '無法解压ZIP文件',
];
