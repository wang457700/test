...
return [
    ...
    'Parameter %s can not be empty'                         => '参数%s不能為空',
    'Are you sure you want to delete the %s selected item?' => '確定刪除选中的 %s 项?',
    'Are you sure you want to delete this item?'            => '確定刪除此项?',
    'Are you sure you want to delete or turncate?'          => '確定刪除或清空?',
    'You have no permission'                                => '你没有权限访问',
    'Please enter your username'                            => '请输入你的用戶名',
    'Please enter your password'                            => '请输入你的密码',
    'Please login first'                                    => '請登入後操作',
    'You can upload up to %d file%s'                        => '你最多还可以上傳%d个文件',
    'You can choose up to %d file%s'                        => '你最多还可以選擇%d个文件',
    ...
    'Config tips'                                           => '可以在此增改系统的变量和分组,也可以自定义分组和变量,如果需要刪除请从数据库中刪除',
    'Category tips'                                         => '用于统一管理网站的所有分类,分类可进行無限级分类',
    'Attachment tips'                                       => '主要用于管理上傳到服务器或第三方存储的数据',
