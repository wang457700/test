...
class Cart extends Frontend
{
    ...
    public function shopping_cart(){
        ...
        $list= Db::name('cart_order')->alias('a')->field('c.*,a.product_id as goods_id,a.user_id,a.cart_id')->join('__GOODS__ c','a.product_id=c.product_id','RIGHT')->where('user_id',8)->group('c.product_id')->select();
