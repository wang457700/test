define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'extend/message/index',
                    add_url: '',
                    edit_url: '',
                    del_url: 'extend/message/del',
                    multi_url: '',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        //默认隐藏该列
                        {field: 'name', title: __('聯絡人'), operate:false},
                        //直接响应搜索
                        {field: 'phone', title: __('聯絡電話'), operate: false},
                        {field: 'content', title: __('咨詢內容'),operate: false},
                        {field: 'datetime', title: __('咨詢时间'),operate: false},
        ...
        searchindex: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'extend/message/searchindex',
                    add_url: '',
                    edit_url: '',
                    del_url: 'extend/message/del',
                    multi_url: '',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        //默认隐藏该列
                        //直接响应搜索
                        {field: 'phone', title: __('聯絡電郵地址，微信賬戶'), operate: false},
                        {field: 'content', title: __('貨品描述'),operate: false},
                        {field: 'datetime', title: __('提交时间'),operate: false},
